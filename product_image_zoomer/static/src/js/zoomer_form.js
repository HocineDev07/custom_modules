odoo.define('product_image_zoomer.zoomer_form', function (require) {
    "use strict";
...
import SurveyPreloadImageMixin from "@product_image_zoomer/static/src/js/survey_preload_image_mixin";
import { ImageZoomer } from "@product_image_zoomer/static/src/js/image_zoomer";
const {
    deserializeDate,
    deserializeDateTime,
    parseDateTime,
...
const { resizeTextArea } = require('@web/core/utils/autoresize');
...
publicWidget.registry.SurveyFormWidget = publicWidget.Widget.extend(SurveyPreloadImageMixin, {
    ...
    */
    ...
    _onChoiceImgClick: function (ev) {
        ev.preventDefault();
        this.imgZoomer = new ImageZoomer({
